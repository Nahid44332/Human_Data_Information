...
<body>
    ...
    <div class="card">
      <div class="mb-3 text-center">
        <a href="{{url('/human-identify')}}" class="btn btn-success">অনুসন্ধান</a>
      </div>
        ...
        <form id="sampleForm" action="{{ url('/data-store') }}" method="POST" novalidate enctype="multipart/form-data">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-3">
                ...
                <div class="col">
                    <label for="father_name" class="form-label">পিতার নাম <span
                            class="small text-danger">*</span></label>
                    <input id="father_name" name="father_name" type="text" class="form-control"
                        placeholder="আপনার পিতার নাম" required />
                </div>

                <div class="col">
                    <label for="mother_name" class="form-label">মাতার নাম <span
                            class="small text-danger">*</span></label>
                    <input id="mother_name" name="mother_name" type="text" class="form-control"
                        placeholder="আপনার মাতার নাম" required />
                </div>

                <div class="col">
                    <label for="nid" class="form-label">জাতীয় পরিচয়পত্র / জন্ম নিবন্ধন <span
                            class="small text-danger">*</span></label>
                    <input id="nid" name="nid" type="text" class="form-control"
                        placeholder="NID বা জন্ম নিবন্ধন নম্বর" required />
                ...
                <div class="col">
                    ...
                    <input id="age" name="age" type="text" class="form-control" placeholder="বয়স"
                        readonly />
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea id="address" name="address" rows="3" class="form-control"
                        placeholder="গ্রাম, ইউনিয়ন, উপজেলা , জেলা"></textarea>
                </div>
